...
/*引脚配置*/
#define OLED_W_SCL(x)		gpio_set(GPIO_B,Pin_13,(BitAction)(x))
#define OLED_W_SDA(x)		gpio_set(GPIO_B,Pin_14,(BitAction)(x))
...
//  gpio_init(OLED_GPIO,OLED_SDA_Pin,OUT_OD);
	   gpio_init(GPIO_B,Pin_13,OUT_OD);
	   gpio_init(GPIO_B,Pin_14,OUT_OD);
